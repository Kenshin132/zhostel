...
<body class="bg-light">
        ...
        echo <<<bookings
            <div class='col-md-4 px-4 mb-4'>
              <div class='bg-white p-3 rounded shadow-sm'>
                ...
                <button class="btn btn-primary btn-sm shadow-none" onclick="printPDF($data[booking_id])">Print Invoice</button>
                $btn
              </div>
            </div>
          bookings;
  ...
  <script>
    ...
    // create function for printing pdf
    function printPDF(id) {
      window.open(`./components/invoice.php?invoice&id=${id}`, "_blank");
    }
